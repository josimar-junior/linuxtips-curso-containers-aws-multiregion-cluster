...
resource "aws_ssm_parameter" "lb_external_listener" {
  type  = "String"
...
resource "aws_ssm_parameter" "lb_internal_listener_https" {
  type  = "String"
...
resource "aws_ssm_parameter" "service_discovery_service_connect" {
  type  = "String"
